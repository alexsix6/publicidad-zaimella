        ...
        tools: [
          {
            ...
            description: 'Generate complete content package (copy + image + video) for marketing campaigns',
            inputSchema: {
              type: 'object',
              properties: {
                brief: {
                ...
                voice_preference: {
                  type: 'string',
                  enum: ['generic', 'custom'],
                  description: 'Voice generation preference (generic = Veo3, custom = ElevenLabs)'
                },
                context_gathering: {
                  type: 'string',
                  enum: ['proactive', 'reactive', 'hybrid'],
                  default: 'hybrid',
                  description: 'Context gathering strategy'
                }
              },
              required: ['brief']
            }
