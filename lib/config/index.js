...
function loadEnvFile() {
  try {
    ...
    console.log(`[INFO] Environment variables loaded: ${loadedCount} variables from .env.local`);
  } catch (error) {
    console.warn('[WARN] Could not load .env.local:', error.message);
    console.warn('[WARN] Using process.env only');
  }
}
